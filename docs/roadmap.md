...
- Host import UI to run sidecar + show progress.
- Packaging proof: Windows + Linux.

**Exit criteria**
- User imports an mp3 and gets a SongPack playable in-app.
...
**Exit criteria**
- Plugins can be added/updated without modifying the host.

**UI requirement checkpoint (from `spec.md`)**
- The host UI always shows **current key + mode** during playback.
