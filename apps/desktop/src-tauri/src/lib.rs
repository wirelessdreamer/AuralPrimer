...
#[tauri::command]
fn proprietary_archive_import_preflight(app: AppHandle, data_root: Option<String>, external_decoder_cli_path: Option<String>) -> Result<proprietary_archive_import::proprietary_archive_importPreflight, String> {
...
#[tauri::command]
fn set_proprietary_archive_import_settings(app: AppHandle, data_root: Option<String>, external_decoder_cli_path: Option<String>) -> Result<(), String> {
    let paths = get_paths(&app)?;
    let mut settings = load_settings(&paths);
...
#[tauri::command]
fn proprietary_archive_import_scan_dlc(app: AppHandle, data_root: Option<String>) -> Result<Vec<proprietary_archive_import::proprietary_archive_importSongEntry>, String> {
    let root = data_root.unwrap_or(get_proprietary_archive_import_data_root(&app)?);
    proprietary_archive_import::scan_dlc(Path::new(&root))
}

#[tauri::command]
fn proprietary_archive_import_import_preview(app: AppHandle, checksum: String, data_root: Option<String>, external_decoder_cli_path: Option<String>) -> Result<proprietary_archive_import::proprietary_archive_importImportResult, String> {
    let root = data_root.unwrap_or(get_proprietary_archive_import_data_root(&app)?);
    let vgm = if external_decoder_cli_path.is_some() {
        external_decoder_cli_path
    } else {
...
#[tauri::command]
fn proprietary_archive_import_import_all(app: AppHandle, data_root: Option<String>, external_decoder_cli_path: Option<String>) -> Result<Vec<proprietary_archive_import::proprietary_archive_importImportAllResult>, String> {
    let root = data_root.unwrap_or(get_proprietary_archive_import_data_root(&app)?);
    let vgm = if external_decoder_cli_path.is_some() {
        external_decoder_cli_path
    } else {
