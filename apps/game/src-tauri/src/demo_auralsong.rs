//! Utilities for creating a tiny non-copyright demo AuralSong.
//!
...
fn demo_auralsong_dir(songs_folder: &Path) -> PathBuf {
    songs_folder.join("demo_sine_440hz.auralsong")
}
...
/// Ensure a demo AuralSong exists in the songs folder.
///
/// Returns:
...
pub fn ensure_demo_auralsong(songs_folder: &Path) -> Result<Option<PathBuf>, String> {
    ...
    let manifest = serde_json::json!({
        ...
        "source": {
            "kind": "demo",
            "generator": "demo_auralsong::ensure_demo_auralsong",
            "hz": 440,
            "duration_sec": duration_sec,
