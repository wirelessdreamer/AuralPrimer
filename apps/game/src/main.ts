      ...
      <section class="route" data-route="make">
        <section class="panel">
          ...
          <p class="meta">
            ...
            Suno stem+MIDI import, sidecar ingest import, proprietary_archive_import import, and model-pack setup.
          </p>
          <div class="row">
      ...
      <section class="route" data-route="config">
        <div class="twoCol">
          <section class="panel">
            ...
            <h3>Import proprietary_archive_import songs (MVP)</h3>
            <p class="meta">
              This importer scans your local <strong>proprietary_rhythm_archive World Tour Definitive Edition</strong> <code>DATA</code> folder
              and imports each DLC songâ€™s <code>*_preview.unsupported_archive.unsupported_archive</code> into an AuralPrimer SongPack.
              <br />
            ...
            <div class="row">
              ...
              <button id="proprietary_archive_importBrowse">Browseâ€¦</button>
            </div>
            <div class="row">
            ...
            <p class="meta">
              Manual access to the Python ingest sidecar for import, folder scan, unsupported_chart_format, custom config JSON, and explicit output path control.
            </p>
            <div class="row">
              <label class="meta">Mode</label>
              <select id="ingestMode">
                ...
                <option value="import-unsupported_chart_format">import-unsupported_chart_format (unsupported_chart_format chart)</option>
              </select>
            </div>
            <div class="row">
              <label class="meta">Source</label>
...
function sourcePlaceholderForIngestMode(mode: IngestSubcommand): string {
  ...
  if (mode === "import-unsupported_chart_format") return "C:\\charts\\song.unsupported_chart_format";
...
async function proprietary_archive_importScanDlc() {
  ...
  setproprietary_archive_importStatus("Scanning DLCâ€¦");
  proprietary_archive_importSongs = [];
...
async function proprietary_archive_importImportAll() {
  ...
  setproprietary_archive_importStatus("Importing all DLC songsâ€¦");
  proprietary_archive_importImportAllBtn.disabled = true;
...
async function proprietary_archive_importImportSong(checksum: string) {
  ...
  setproprietary_archive_importStatus(`Importing ${checksum}â€¦`);
...
void listen<proprietary_archive_importImportProgressEvent>("proprietary_archive_import_import_progress", (ev) => {
  ...
  setproprietary_archive_importStatus(`${p.song}: ${pct}% Â· ${p.id}${msg}`);
});
