      ...
      <section class="route" data-route="make">
        <section class="panel">
          ...
          <p class="meta">
            ...
            stems+MIDI SongPack creator, sidecar ingest import, proprietary_archive_import import, and model-pack setup.
          </p>
          <div class="row">
      ...
      <section class="route" data-route="config">
        <div class="twoCol">
          <section class="panel">
            ...
            <p class="meta">
              Run the Python ingest sidecar directly to create SongPacks from audio files, folders, or unsupported_chart_format charts.
            </p>
            <div class="row">
