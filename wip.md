...
- [~] Implement ingest sidecar MVP (decode + beats/tempo + sections + chart gen)
  ...
  - [x] Sidecar CLI surface (current): `aural_ingest stages|info|validate|import|import-dir|import-unsupported_chart_format`
...
- [ ] (New) proprietary_archive_import-DE importer (MVP: preview audio)
