"""HPSS + onset-aware YIN — experiment combining HPSS and onset detection.

HPSS removes percussive transients, onset detection segments repeated
notes. This should help on guitar tracks with lots of pick noise.
"""
...
from aural_ingest.algorithms.melodic_yin import _yin_pitch_np, _midi_from_freq, _HAS_NUMPY
    ...
    *,
    ...
    while i + frame <= len(samples):
        if use_np:
            ...
            freq = None  # pure-python fallback would be too slow
